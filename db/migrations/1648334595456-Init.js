module.exports = class Init1648334595456 {
  name = 'Init1648334595456'

  async up(db) {
    await db.query(`CREATE TABLE "datalog" ("id" character varying NOT NULL, "moment" integer NOT NULL, "record" text NOT NULL, "account_id" character varying NOT NULL, CONSTRAINT "PK_bbff9d67f9f671c530a2765dc37" PRIMARY KEY ("id"))`)
